...
const staffUsers = [
  ...
  },
  {
    ...
    email: 'teacher@demo.doctarx.com',
    firstName: 'Ifeoma',
    lastName: 'Nwosu',
  ...
  },
  {
    ...
    email: 'teacher2@demo.doctarx.com',
    firstName: 'Samuel',
    lastName: 'Danladi',
    role: NURSING_ROLES.LECTURER,
  ...
  {
    id: 'user-coordinator',
    email: 'coordinator@demo.doctarx.com',
    firstName: 'Grace',
    lastName: 'Eze',
  ...
  },
  {
    ...
    email: 'supervisor@demo.doctarx.com',
    firstName: 'Fatima',
    lastName: 'Yakubu',
  ...
  },
  {
    ...
    email: 'supervisor2@demo.doctarx.com',
    firstName: 'John',
    lastName: 'Odey',
    role: NURSING_ROLES.SUPERVISOR,
  ...
  },
  {
    ...
    email: 'support@demo.doctarx.com',
    firstName: 'Tomi',
    lastName: 'Lawal',
...
const studentUsers = studentNames.map(([firstName, lastName], index) => {
  ...
  return {
    ...
    email: index === 0 ? 'student@demo.doctarx.com' : `student${number}@demo.doctarx.com`,
    firstName,
    lastName,
